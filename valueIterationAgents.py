...
#References: https://github.com/YidaYin/Berkeley-CS188-Project-3/blob/master/valueIterationAgents.py
...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def computeQValueFromValues(self, state, action):
        ...
        for trans in self.mdp.getTransitionStatesAndProbs(state,action):
        	qv += trans[1]*(
        	self.mdp.getReward(state,action,trans[0])+self.discount*self.values[trans[0]])
        return qv
		'''
        qv = 0
